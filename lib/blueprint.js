...
// Custom field types
export const supportedFieldTypes = ['dealField', 'personField', 'organizationField', 'productField'];

// Sub-objects which are not exposed as main objects
export const selfManagedRelatedObjects = ['followers'];

// Object types which are searchable
export const searchableObjects = ['organizations', 'deals', 'persons', 'products', 'users'];

// Object types which support timeline APIs
export const timelineableObjects = ['deals'];
...
export const mergeableObjects = ['persons', 'organizations', 'deals'];
...
// type custom fields.
export const objectsSupportingFieldValueSearch = ['searchResults'];
